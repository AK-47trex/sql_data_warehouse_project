...
<ul>
  <li><b>Purpose:</b> Stores customer details enriched with demographic and geographic data.</li>
  <li><b>Columns:</b></li>
</ul>
...
<ul>
  <li><b>Purpose:</b> Provides information about the products and their attributes.</li>
  <li><b>Columns:</b></li>
</ul>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>start_date</td>
      <td>DATE</td>
      <td>The date when the product became available for sale or use, stored in YYYY-MM-DD format.</td>
    </tr>
  </tbody>
</table>
...
<ul>
  <li><b>Purpose:</b> Stores transactional sales data for analytical purposes.</li>
  <li><b>Columns:</b></li>
</ul>
